...
from simulator.core.continuous_batch_sim import ContinuousBatchRequest, simulate_continuous_batch
from simulator.config import routing_strategy_specs, static_qos_config
from simulator.adapters.shared_path import shared_path_adapter, IO_GIB
...
def example_trace():
    ...
    for npu in range(4):
        for generation in range(3):
            ...
            placement = (tuple((sim.block_ring_hash_disk_id(rid, i, 2), IO_GIB)
                               for i in range(32)),)
