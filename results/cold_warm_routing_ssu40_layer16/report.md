...
Provenance: this comparison merges paired, behavior-compatible runs and preserves a separate source fingerprint for each strategy. It is not presented as a single-checkout rerun; see `comparison_results.json` for file hashes and row sources.
...
| Read once/layer + L0 prefetch — cold | 55.35% |
| Read once/layer + L0 prefetch — warm | 59.90% |
...
| Read once/layer + L0 prefetch — cold | 65.49% |
| Read once/layer + L0 prefetch — warm | 77.34% |
