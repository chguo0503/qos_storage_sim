...
def main():
    ...
    for seed in (7, 19, 43, 67, 101):
        ...
        for npu in range(32):
            ...
            expected = [3, 3, 3, 15] if npu < 17 else [4, 4, 4, 13] if npu < 20 else [17 if npu < 29 else 16] * 3 + [11 if npu < 26 else 10]
    ...
    (HERE / "mixed_design_v4_checks.json").write_text(json.dumps(output, indent=2) + "\n")
