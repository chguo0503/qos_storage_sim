...
32 NPU、4 SSU × 40 GiB/s、seed 7，warm [2,4) 秒。使用完整 Once 仿真的原始日志。

| 顺序 | NPU 利用率 | 总需求均值 GiB/s | 总供给均值 GiB/s | 图 |
|---|---:|---:|---:|---|
| Ordered | 93.5429% | 177.695881 | 119.281585 | [PNG](ordered_total_demand_supply.png) · [PDF](ordered_total_demand_supply.pdf) |
| Random | 99.3008% | 125.889431 | 120.025606 | [PNG](random_total_demand_supply.png) · [PDF](random_total_demand_supply.pdf) |
