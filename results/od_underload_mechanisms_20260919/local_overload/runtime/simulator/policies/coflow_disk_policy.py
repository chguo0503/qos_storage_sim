...
def main():
    candidates = (PathCandidate(0, 1.0, (20.0,)),
                  PathCandidate(32, 1.0, (2.0,)),
                  PathCandidate(64, 2.0, (0.0,)))
    assert choose_path(candidates, 0).path_id == 32
    assert choose_path((PathCandidate(0, 1.0, (1,)), PathCandidate(32, 1.0, (1,))), 1).path_id == 32
    print("coflow_disk_policy: PASS (priority changes only minimum-finish ties)")
