...
from inputs.runners.run_coflow_experiments import OUT, ROOT, REGIME, STRATEGIES, _atomic_json
...
def execute(job, output, python, policy_config=None):
    ...
    command = [python, "-B", str(ROOT / "inputs/runners/run_coflow_experiments.py"),
