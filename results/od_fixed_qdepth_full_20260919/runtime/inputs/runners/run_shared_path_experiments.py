...
Clients use 176 KiB I/O. OD uses equal static per-NPU CIR; other clients use
the original FINAL_STATIC table. ``baseline`` is a legacy ASU alias.
...
STRATEGIES = ("asu_baseline", "od_baseline", "once", "new_once", "strategy1", "strategy2", "baseline")
