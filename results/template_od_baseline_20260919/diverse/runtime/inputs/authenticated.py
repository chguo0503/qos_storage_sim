...
from inputs.random_steady_state import catalog_hash
...
def load_authenticated_bw_table(num_npu: int):
    ...
    ``catalog.load_bw_table_cache`` normally prefers an optional results-side NPZ.
    ...
    if cache_path.exists():
        cached = catalog.load_bw_table_cache(
