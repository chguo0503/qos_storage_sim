...
from simulator.policies.common import IO_GIB, solo_io_ms
...
def main():
    ...
    choice = choose_npu(5, lanes, (64, 64), 1, snapshot_counts_by_ssu=((8, 4), (3, 2)))
    assert choice.npu_id == 1
    assert len(choice.scores_ms) == len(lanes)
    release = prefetch_release_ms(5, 30, (64, 64), ((8, 4), (3, 2)))
    assert 5 <= release <= 30
    assert prefetch_release_ms(5, 30, (0, 0), (0, 0)) == 5
    assert prefetch_release_ms(5, 5, (64, 64), (0, 0)) == 5
    print("strategy1: PASS (known backlog assignment and nonnegative prefetch release)")
